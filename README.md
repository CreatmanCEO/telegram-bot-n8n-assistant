> **[Legacy / No Longer Maintained]** This project is archived and is not actively developed. It remains available as a reference implementation.
...
Проект заархивирован и не поддерживается. Код доступен для ознакомления.
